...
CREATE TABLE `order` (
 ...
 `total_cost` DECIMAL(10,2) UNSIGNED NOT NULL COMMENT "Стоимость|Стоимость заказа",
 `system_fee` DECIMAL(10,2) UNSIGNED NOT NULL COMMENT "Комиссия|Комиссия системы",
 `executor_fee` DECIMAL(10,2) UNSIGNED NOT NULL COMMENT "Плата|Плата исполнителю за выполнение заказа",
